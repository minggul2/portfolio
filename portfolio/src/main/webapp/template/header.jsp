...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo"><b>타자연습<span>SITE</span></b></a>
      <!--logo end-->
      ...
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
          <c:if test="${sessionScope.id == null}">
          	<li><a class="logout" href="/member/login.do">로그인</a></li>
          	<li><a class="logout" href="/member/join.do">회원가입</a></li>
          </c:if>
          <c:if test="${sessionScope.id != null}">
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <c:if test = "${id != null}">
	          <h5 class="centered">${id}</h5>
          </c:if>
          <c:if test = "${id == null}">
	          <h5 class="centered">로그인하세요</h5>
          </c:if>
          <li class="mt">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li><a href="/typing/kr.do">한글 문장연습</a></li>
